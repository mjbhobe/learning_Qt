"""
* dockWidgets - illustrates doc widgets
* @author: Manish Bhobe
...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        self.newLetterAct = QAction(QIcon(':/file_new.png'), "&New Letter",
        ...
        self.undoAct = QAction(QIcon(':/edit_undo.png'), "&Undo", self,
                               shortcut=QKeySequence.Undo,
                               statusTip="Undo the last editing action", triggered=self.undo)

        self.quitAct = QAction(QIcon(':/on-off.png'), "&Quit", self, shortcut="Ctrl+Q",
