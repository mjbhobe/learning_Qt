...
DrawWindow::DrawWindow()
{
   ...
   QObject::connect(
      _doodle, SIGNAL(doodleModified(bool)), this, SLOT(doodleModified(bool)));
...
void DrawWindow::changePenColor()
{
   ...
   if (color.isValid()) _doodle->setPenColor(color);
}
...
void DrawWindow::fileOpen()
{
   if (canClose()) {
      QString fileName = QFileDialog::getOpenFileName(
         this, tr("Open Qt Scribble File"), QDir::currentPath(), ScribbleFiles);
