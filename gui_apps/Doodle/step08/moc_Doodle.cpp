...
void Doodle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Doodle *_t = static_cast<Doodle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Doodle::*_t)(const QColor & );
...
const QMetaObject Doodle::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Doodle.data,
      qt_meta_data_Doodle,  qt_static_metacall, nullptr, nullptr}
};
